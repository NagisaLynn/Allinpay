...
namespace Allinpay
{
    ...
    public class AllinpayRespondModel
    {
        ...
        public string PAY_AMOUNT { get; set; } //  Payment amount

        public string EXCHANGE_RATE { get; set; } //  Exchange rate
        public string ACTUALLY_AMOUNT { get; set; } //  The amount actually paid
